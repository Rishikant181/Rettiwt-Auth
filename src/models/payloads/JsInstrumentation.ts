// TYPES
import { IJsInstrumentationInput } from "../../types/request/payloads/JsInstrumentation";

/**
 * The payload for obtaining the various login options available.
 */
export class JsInstrumentationInput implements IJsInstrumentationInput {
    ...
    /**
     * Initializes a payload to be sent for this subtask.
     */
    constructor() {
